...
from config import BOT_TOKEN, LOG_LEVEL, LOG_FORMAT, DATABASE_PATH
...
async def expire_unpaid_loop(bot: Bot):
    """Каждую минуту истекаем неоплаченные брони (30 минут по config)."""
    from config import BOOKING_TIMEOUT_MINUTES
    while True:
        try:
